...
format, the image file is formatted as it is.  See the following link:
[[file:///Users/bcui/Downloads/tdg5/en/html/docbook.html][file:/Users/bcui/Org/docbook-cover.png]]
...
found in the verse or quote, an =<attribute>= element will be added to
...
#+BEGIN_EXAMPLE
    Some example from a text file.  This can includes characters like '<'
    and '>', etc.
